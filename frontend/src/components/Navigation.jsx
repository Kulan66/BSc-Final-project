// src/components/AdvancedNavigation.jsx
...
            Products
          </Link>
          <Link to="/class" className="hover:text-white transition-colors">
            Class
          </Link>
...
              Products
            </Link>
            <Link to="/class" onClick={toggleMenu} className="block hover:text-gray-300">
              Class
            </Link>
            <Link to="/companies" onClick={toggleMenu} className="block hover:text-gray-300">
              companies
            </Link>
            <Link to="/chat" className="hover:text-white transition-colors">
              Chat
...
                  Create Insurance
                </Link>
                <Link to="/bookings" onClick={toggleMenu} className="block hover:text-gray-300">
                  Bookings
                </Link>
              </>
            )}
